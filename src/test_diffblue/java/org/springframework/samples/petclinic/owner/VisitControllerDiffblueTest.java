...
class VisitControllerDiffblueTest {
  ...
  /**
  * Method under test: {@link VisitController#initNewVisitForm(int, Map)}
  */
  @Test
  ...
  /**
   * Method under test: {@link VisitController#processNewVisitForm(Owner, int, Visit, BindingResult)}
   */
  @Test
